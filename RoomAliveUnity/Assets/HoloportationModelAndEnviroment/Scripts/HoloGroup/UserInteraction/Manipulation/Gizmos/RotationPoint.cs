...
{
    public class RotationPoint : ManipulatorGizmos, IManipulatable, INavigatable
    {
        #region Entities
        #region Enums
        #endregion
        ...
        #region Classes
        [Serializable]
        public class ManipulationStartedEvent : UnityEvent<RotationPoint, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class ManipulationUpdatedEvent : UnityEvent<RotationPoint, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class ManipulationCompletedEvent : UnityEvent<RotationPoint, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class ManipulationCanceledEvent : UnityEvent<RotationPoint, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class NavigationStartedEvent : UnityEvent<RotationPoint, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class NavigationUpdatedEvent : UnityEvent<RotationPoint, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class NavigationCompletedEvent : UnityEvent<RotationPoint, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class NavigationCanceledEvent : UnityEvent<RotationPoint, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }
        #endregion
