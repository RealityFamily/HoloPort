...
{
    public class Corner : ManipulatorGizmos, IManipulatable, INavigatable
    {
        #region Entities
        #region Enums
        #endregion
        ...
        #region Classes
        [Serializable]
        public class ManipulationStartedEvent : UnityEvent<Corner, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class ManipulationUpdatedEvent : UnityEvent<Corner, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class ManipulationCompletedEvent : UnityEvent<Corner, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class ManipulationCanceledEvent : UnityEvent<Corner, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class NavigationStartedEvent : UnityEvent<Corner, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class NavigationUpdatedEvent : UnityEvent<Corner, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class NavigationCompletedEvent : UnityEvent<Corner, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }

        [Serializable]
        public class NavigationCanceledEvent : UnityEvent<Corner, UnityEngine.XR.WSA.Input.InteractionSourceKind, Vector3, Ray> { }
        #endregion
